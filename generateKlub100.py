...
# loc = "C:\\Users\\mfrue\\OneDrive - Danmarks Tekniske Universitet\\Privat\\Klub100\\"
...
#tilføj en tilfældig effekt fra en fast mappe hvis den laveste hastighed i et mashed tilfældigt klip er under 0.25.
#lookupspeed sammenholder med en liste med hastigheder fra seneste effekt og regner som standard minimum.
...
#tilføj pauser. limieted pauser stopper med at blive tilføjet, når alle effekterne er brugt én gang.
...
#tilføj overlays på specifikke positioner på sangen "helmig".
test.addSoundOverlay("DIR-pat", [30.5,36.5,42.5,48,53.5],ID="helmig",db=0)
test.addCondition("helmig", [test.lookupCurrentSongName,"helmig"])
